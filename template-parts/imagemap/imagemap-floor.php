...
<?php if($general_image_mapping){ ?>
											...
											while (have_rows('increase_apartment_variations_coordinates')){ the_row(); ?>
												<a xlink:href="<?php the_permalink(); ?>">
													<polygon
														...
														data-index="0"
														data-id="shape-<?php echo $i; ?>-<?php the_ID(); ?>"
														points="<?php the_sub_field('increase_apartment_variations_coordinates_item'); ?>"
												...
												while (have_rows('increase_apartment_coordinates')){ the_row(); ?>
													<a xlink:href="<?php the_permalink(); ?>">
														<polygon
															...
															points="<?php the_sub_field('increase_apartment_coordinates_item'); ?>"
	...
	<?php if( have_rows('increase_imagemap_floor_legend', 'options') ){ ?>
		<div  class="position-relative legenda-index increase-imagemap-legend p-3 d-flex justify-content-center ">
			<h5 class="font-weight-light" ><?php _e('Legenda:','increase'); ?></h5>
			<?php $i=1; while ( have_rows('increase_imagemap_floor_legend', 'options') ) : the_row(); ?>
				<span style="color:#04378c; font-size:18px; font-weight: lighter;">
					<span style="margin:0 20px;    padding: 3px 13px; background-color: <?php the_sub_field('increase_imagemap_floor_legend_color', 'options'); ?>;"></span> <?php the_sub_field('increase_imagemap_floor_legend_title', 'options'); ?>
				</span>
			<?php $i++; endwhile; ?>
		</div>
	<?php }	?>
